...
namespace Core.Bot.MessagesQueue.Classes {
    public class PhotoMessage(ChatId chatId, InputFile photo, string? caption, ReplyMarkup? replyMarkup, string? path, bool hasSpoiler, bool disableNotification, ParseMode parseMode) : IMessageQueue {
